    ...
    return (
        <form>
            ...
            <select value={selectedJob} onChange={handleChange}>
                <option value="" disabled>---Please choose a job---</option>
                <option value="Software Developers">Software Engineer</option>
                <option value="Janitors and Cleaners, Except Maids and Housekeeping Cleaners">Janitor</option>
                <option value="Career/Technical Education Teachers, Postsecondary">Teacher</option>
